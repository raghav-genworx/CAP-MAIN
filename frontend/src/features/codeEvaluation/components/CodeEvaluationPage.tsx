...
import {
  ...
  type EvaluationTest,
} from "../utils/evaluationViewModel";
import {
      ...
      <section className="question-breakdown">
        ...
        {questionBreakdown.map((question) => (
          <article
            ...
            className={`scorecard-question-detail ${question.evaluation_status === "not_attempted" ? "is-not-attempted" : ""}`}
          >
            <header>
              <div>
            ...
            {question.evaluation_status !== "not_attempted" ? (
              <div className="score-split question-score-split">
                <ScorePart label="Hidden tests" value={question.test_case_score ?? 0} />
                <ScorePart label="Coding metrics" value={question.coding_score ?? 0} />
                <ScorePart label="AI quality" value={question.ai_score ?? 0} />
              </div>
            ) : null}
