  ...
  return (
    <section className="settings-panel notification-preferences">
      ...
      <div className="notification-recommendation">
        ...
        <span>
          For large assessments (1000+ candidates), milestone or grouped
          notifications are recommended to avoid a flooded inbox.
        </span>
      </div>
      ...
      <div className="notification-actions">
        ...
        <button
          ...
          onClick={handleSave}
          disabled={
            settingsQuery.isLoading || updateSettings.isPending || milestoneError
          }
        >
