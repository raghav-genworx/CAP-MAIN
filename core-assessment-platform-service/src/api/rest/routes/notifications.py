...
async def stream_notifications(
    ...
    initial_payload = await run_in_threadpool(service.stream_snapshot, recruiter_uid)
...
async def mark_read(
    ...
    return await run_in_threadpool(
        service.mark_read, current_user.uid, notification_id
    )
...
async def update_settings(
    ...
    return await run_in_threadpool(
        service.update_settings, current_user.uid, payload
    )
