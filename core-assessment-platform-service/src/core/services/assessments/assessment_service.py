...
from core.services.assessments.assessment_lifecycle import (
...
from core.services.assessments.assessment_policy import (
...
from core.services.assessments.candidate_csv_import import parse_candidate_csv
from core.services.assessments.candidate_execution_policy import (
...
from core.services.assessments.evaluation_payload_builder import (
    build_evaluation_payload,
)
from core.services.auth.candidate_session_service import CandidateSessionService
from core.services.evaluation.ports import build_evaluation_port
...
class AssessmentService:
    ...
    def __init__(self, session: Session, settings: Settings | None = None) -> None:
        ...
        # Resolved by transport, not constructed directly: EXECUTION_TRANSPORT
        # and EVALUATION_TRANSPORT decide whether these cross the network.
        self._execution_adapter = build_execution_port(self._settings)
        self._evaluation_adapter = build_evaluation_port(self._settings)
...
def dispatch_slot_invites_background(
    *,
    ...
    from data.clients.postgres_client import create_session_factory
