...
from data.clients.postgres_client import session_factory_for_url
from data.models.postgres.evaluation import (
...
class EvaluationRepository:
    ...
    def __init__(
        ...
        *,
        ...
        self._session_factory = session_factory or session_factory_for_url(database_url)
